...
async function seed() {
  ...
  const users: DbUser[] = [
    { id: userIds.admin, email: 'admin@rct.tn', password: hashedPassword123, name: 'Ahmed Ben Salem', avatar: 'https://i.pravatar.cc/150?u=admin', role: 'admin', level: 'élite', group_name: 'Élite', distance: 1250, runs: 156, joined_events: 89, strava_connected: true, strava_id: 'strava_admin', strava_access_token: null, strava_refresh_token: null, strava_token_expires_at: null, created_at: now, updated_at: now },
    { id: userIds.coach, email: 'coach@rct.tn', password: hashedPassword456, name: 'Fatma Trabelsi', avatar: 'https://i.pravatar.cc/150?u=coach', role: 'coach', level: 'élite', group_name: 'Élite', distance: 2100, runs: 245, joined_events: 120, strava_connected: true, strava_id: 'strava_coach', strava_access_token: null, strava_refresh_token: null, strava_token_expires_at: null, created_at: now, updated_at: now },
    { id: userIds.member1, email: 'mohamed@rct.tn', password: hashedPassword789, name: 'Mohamed Khelifi', avatar: 'https://i.pravatar.cc/150?u=mohamed', role: 'member', level: 'intermédiaire', group_name: 'Intermédiaire', distance: 456, runs: 67, joined_events: 34, strava_connected: true, strava_id: 'strava_mohamed', strava_access_token: null, strava_refresh_token: null, strava_token_expires_at: null, created_at: now, updated_at: now },
    { id: userIds.member2, email: 'leila@rct.tn', password: hashedPasswordDefault, name: 'Leila Mansour', avatar: 'https://i.pravatar.cc/150?u=leila', role: 'member', level: 'intermédiaire', group_name: 'Intermédiaire', distance: 520, runs: 78, joined_events: 45, strava_connected: false, strava_id: null, strava_access_token: null, strava_refresh_token: null, strava_token_expires_at: null, created_at: now, updated_at: now },
    { id: userIds.member3, email: 'youssef@rct.tn', password: hashedPasswordDefault, name: 'Youssef Chaabane', avatar: 'https://i.pravatar.cc/150?u=youssef', role: 'group_admin', level: 'débutant', group_name: 'Débutant', distance: 123, runs: 23, joined_events: 12, strava_connected: true, strava_id: 'strava_youssef', strava_access_token: null, strava_refresh_token: null, strava_token_expires_at: null, created_at: now, updated_at: now },
    { id: userIds.member4, email: 'amira@rct.tn', password: hashedPasswordDefault, name: 'Amira Bouazizi', avatar: 'https://i.pravatar.cc/150?u=amira', role: 'member', level: 'débutant', group_name: 'Débutant', distance: 89, runs: 15, joined_events: 8, strava_connected: false, strava_id: null, strava_access_token: null, strava_refresh_token: null, strava_token_expires_at: null, created_at: now, updated_at: now },
    { id: userIds.member5, email: 'karim@rct.tn', password: hashedPasswordDefault, name: 'Karim Mejri', avatar: 'https://i.pravatar.cc/150?u=karim', role: 'member', level: 'élite', group_name: 'Élite', distance: 890, runs: 112, joined_events: 67, strava_connected: true, strava_id: 'strava_karim', strava_access_token: null, strava_refresh_token: null, strava_token_expires_at: null, created_at: now, updated_at: now },
  ];
  ...
  const chatGroups: DbChatGroup[] = [
    { id: chatGroupIds.general, name: 'Général RCT', description: 'Groupe principal du club pour les annonces et discussions générales', event_id: null, created_by: userIds.admin, created_at: now, updated_at: now },
    { id: chatGroupIds.elite, name: 'Groupe Élite', description: 'Discussions et entraînements pour le groupe Élite', event_id: null, created_by: userIds.coach, created_at: now, updated_at: now },
    { id: chatGroupIds.intermediate, name: 'Groupe Intermédiaire', description: 'Discussions et entraînements pour le groupe Intermédiaire', event_id: null, created_by: userIds.coach, created_at: now, updated_at: now },
    { id: chatGroupIds.beginners, name: 'Groupe Débutant', description: 'Conseils et discussions pour les nouveaux coureurs', event_id: null, created_by: userIds.coach, created_at: now, updated_at: now },
  ];
